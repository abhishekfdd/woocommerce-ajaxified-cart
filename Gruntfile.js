...
module.exports = function ( grunt ) {
	...
	grunt.initConfig( {
		...
		uglify: {
			...
			frontend: {
				files: {
					'assets/js/abwc-ajax-cart.min.js': [ 'assets/js/abwc-ajax-cart.js' ],
		...
		checktextdomain: {
			options: {
				text_domain: [ 'abwc-ajax-cart' ], // Specify allowed domain(s).
		...
		makepot: {
			target: {
				options: {
					...
					potFilename: 'abwc-ajax-cart.pot', // Name of the POT file.
